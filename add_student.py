...
from DBContext import add_student
...
class AddStudentWindow(QWidget):
    def __init__(self):
        ...
        self.welcomelabel = QLabel("Add student", self)
        ...
        std_label = QLabel("Student System")
        std_label.setStyleSheet('color: lightgreen; font-size: 25px;')
        
        sidebar_content.addWidget(std_label, alignment= Qt.AlignCenter)
...
"""
        ...
        enroll_date_label = QLabel("Date of Enroll")
        ...
        btn = QPushButton("Students Table" )   
        btn.setFixedHeight(80)
        btn.setFixedWidth(400)
        # btn.clicked.connect(self.open_std_table)
        btn.setStyleSheet("""
...
""")
    ...
    def add_std(self):
        ...
        doe=self.enroll_date_input.text()
        std = Student(fn,ln,em,bd,doe)
        add_student(std,self)
    # def open_std_table(self):
    #     self.s = StudentWindow()
    #     self.s.show()  
